...
class GUI:
    ...
    def __init__(self):
        ...
        self.refresh_button = tk.Button(frame_top, text="Refresh table", command=self.refresh_table)
...
class Tab_BPM(GUI):
    def __init__(self):
        ...
        self.setYAxisInterval_cb = ttk.Checkbutton(self.tab1, text="Set y-axis interval:", variable=self.setYInterval_val, command=self.activate_interval)
        ...
        self.showDISCDISQ_cb = ttk.Checkbutton(self.tab1, text="Show disconnected / disqualified drivers", variable=self.DISQDISC_val)
